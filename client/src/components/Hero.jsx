...
const Hero = () => {
  ...
  return (
    <div className='container px-4 2xl:px-20 mx-auto flex flex-col gap-8 py-16'>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
            <h2 className='text-2xl md:text-3xl lg:text-4xl font-medium md-4'>Over 10,000+ jobs to apply</h2>
            ...
            <div className='flex items-center justify-betweeen bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
