        ...
        <div className='bg-white text-black rounded-lg w-full'>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
            <div className='flex flex-col md:flex-row items-center'>
              <img  className='h-24 bg-white rounded-lg p-4 mr-4 max-md:mb-4 border'src={JobData.companyId.image} alt="Company Icon" />
            ...
            <div className='flex flex-col justify-center text-sm max-md:mx-auto max-md:text-center'>
              ...
              <p className='mt-1 text-gray-600'>Posted a {moment(JobData.date).fromNow()}</p>
            </div>
          </div>
